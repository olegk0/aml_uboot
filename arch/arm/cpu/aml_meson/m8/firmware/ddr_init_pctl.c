...
#if ((defined LPDDR2) || (defined LPDDR3))
		writel((readl(P_DDR0_PUB_DSGCR))|(0x3<<6), P_DDR0_PUB_DSGCR); //eanble gate extension  dqs gate can help to bit deskew also
		//writel((((readl(P_DDR0_PUB_ZQCR))&0xff01fffc)|(1<<24)), P_DDR0_PUB_ZQCR);
#else
		writel((readl(P_DDR0_PUB_DSGCR))|(0x1<<6), P_DDR0_PUB_DSGCR); //eanble gate extension  dqs gate can help to bit deskew also
...
#if ((defined LPDDR2) || (defined LPDDR3))
		writel((readl(P_DDR1_PUB_DSGCR))|(0x3<<6), P_DDR1_PUB_DSGCR); //eanble gate extension  dqs gate can help to bit deskew also		
#else
		writel((readl(P_DDR1_PUB_DSGCR))|(0x1<<6), P_DDR1_PUB_DSGCR); //eanble gate extension  dqs gate can help to bit deskew also
#endif
